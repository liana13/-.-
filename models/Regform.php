 ...
 class Regform extends ActiveRecord
{
    ...
    {
        return [
            [['email', 'username', 'newpasswordadmin', 'passwordconfirmadmin'], 'required', 'message' => 'заполните поле.'],
            [['status', 'type'], 'integer'],
            ...
            [['is_agent', 'newpasswordadmin', 'passwordconfirmadmin'], 'safe'],
            ['newpasswordadmin', 'string', 'min' => 6],
            ['passwordconfirmadmin', 'compare', 'compareAttribute' => 'newpasswordadmin'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'newpasswordadmin' => Yii::t('app', 'Пароль'),
            'passwordconfirmadmin' => Yii::t('app', 'Повторите пароль'),
    ...
    {
        if($this->newpasswordadmin != null){
           $this->setPassword($this->newpasswordadmin);
        }
