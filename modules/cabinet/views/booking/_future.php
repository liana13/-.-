                        ...
                        <div class="item-header">
                            ...
                            <div class="pull-right">
                                ...
                                <label class="pull-right">
                                    <?=Html::a('<span class="btn btn-default">Отменить бронь</span>',  ['/cabinet/booking/cancelbron/'.$model->id], ["data-confirm"=>"Вы действительно хотите отменить бронь?", "data-method"=>"post"])?>
                                </label>
                            </div>
