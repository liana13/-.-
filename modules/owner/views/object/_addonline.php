...
<div class="object-form">
    <div class="create-object">
        ...
        <div class="fileimgrow row">
            <div class="col-lg-12">
                <label>Загрузите до 50 фото объекта -территории, самого здания и пр.(кроме фото номеров). Фото номеров загружаются в разделе «Категории номеров»</label>
            </div>
            <div class="col-lg-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
             <?= $form->field($model, 'email_booking')->textInput(['placeholder' => "Enter Your Email"])->widget(\yii\widgets\MaskedInput::className(), [
                 ...
                 ])->label('Эл. почта для уведомлений о бронировании <i class="fa fa-question-circle" aria-hidden="true"></i>', ['data-toggle'=>'tooltip', 'title'=>'На этот E-mail будут приходить уведомления о бронировании.']); ?>
            </div>
            <div class="col-lg-4">
              <?= $form->field($model, 'emailsms')->textInput(['placeholder' => "Enter Your Email"])->widget(\yii\widgets\MaskedInput::className(), [
                  ...
                  ])->label('Эл. почта для уведомлений о сообщениях от клиентов <i class="fa fa-question-circle" aria-hidden="true"></i>', ['data-toggle'=>'tooltip', 'title'=>'На этот E-mail будут приходить уведомления о сообщениях или вопросах от клиентов.']); ?>
            </div>
        </div>
        <hr class="hr-object">
        <div class="rowfields">
        ...
        <div class="row">
            <div class="col-sm-6 cust-checkboxmy">
                <h4><label><input type="checkbox" id="objectform-allow_review" name="ObjectForm[allow_review]" value="1" checked> Разрешить писать отзывы об этом объекте</label></h4>
            </div>
        </div>
        <div class="form-group">
...
$imgcount = explode(",",Tarif::findOne(['tarifid'=>$tarifid])->photo)[0];
?>
<script>
