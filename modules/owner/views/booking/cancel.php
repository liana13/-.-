...
$this->title = "Отмененные бронирования";
...
<div class="booking-index">
    <div class="col-sm-12">
        ...
        <div class="search-form">
            <div class="row">
                <?php $form = ActiveForm::begin(['action'=>['/owner/booking/cancel/'.$obj],
                'method' => 'get','options' => ['class' => 'search-form form-inline']]); ?>
                    <?= $form->field($search, 'from',[
                        ...
                        'value'=>(Yii::$app->request->get('canceled')['from'])?Yii::$app->request->get('canceled')['from']:''])->label('Показать даты с') ?>
                    ...
                    <?= $form->field($search, 'to',[
                        ...
                        'value'=>(Yii::$app->request->get('canceled')['to'])?Yii::$app->request->get('canceled')['to']:''])->label('По') ?>
                    ...
                    <?= $form->field($search, 'id')->textInput(['class'=>'form-control calendar-search', 'data-toggle'=>'tooltip', 'title'=> 'Введите уникальный номер бронирования или фамилию клиента',
                        'value'=>(Yii::$app->request->get('canceled')['id'])?Yii::$app->request->get('canceled')['id']:''])->label('Ключевые слова') ?>
    ...
    <div id="exTab2">
        <ul class="nav nav-tabs">
			...
			<li><?=Html::a('Прошедшие бронирования', ['/owner/booking/past/'.$obj])?></li>
            <li class="active"><?=Html::a('Отмененные бронирования', ['/owner/booking/cancel/'.$obj])?></li>
		</ul>
