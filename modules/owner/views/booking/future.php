...
<div class="booking-index">
    <div class="col-sm-12">
        ...
        <div class="search-form">
            <div class="row">
                <?php $form = ActiveForm::begin(['action'=>['/owner/booking/future/'.$obj],
                'method' => 'get','options' => ['class' => 'search-form form-inline']]); ?>
                    <?= $form->field($search, 'from',[
                        ...
                        'value'=>(Yii::$app->request->get('futured')['from'])?Yii::$app->request->get('futured')['from']:''])->label('Показать даты с') ?>
                    ...
                    <?= $form->field($search, 'to',[
                        ...
                        'value'=>(Yii::$app->request->get('futured')['to'])?Yii::$app->request->get('futured')['to']:''])->label('По') ?>
                    ...
                    <?= $form->field($search, 'id')->textInput(['class'=>'form-control calendar-search', 'data-toggle'=>'tooltip', 'title'=> 'Введите уникальный номер бронирования или фамилию клиента',
                        'value'=>(Yii::$app->request->get('futured')['id'])?Yii::$app->request->get('futured')['id']:''])->label('Ключевые слова') ?>
    ...
    <div id="exTab2" class="">
        <ul class="nav nav-tabs">
			<li class="active"><?=Html::a('Бронирования', ['/owner/booking/future/'.$obj])?></li>
